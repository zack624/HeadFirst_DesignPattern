...
import edu.nust.behavioral.commandpattern.command.CellingFanOffCommand;
import edu.nust.behavioral.commandpattern.command.CellingFanOnCommand;
import edu.nust.behavioral.commandpattern.command.Command;
import edu.nust.behavioral.commandpattern.command.LightOffCommand;
import edu.nust.behavioral.commandpattern.command.LightOnCommand;
import edu.nust.behavioral.commandpattern.command.MacroCommand;
